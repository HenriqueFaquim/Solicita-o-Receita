...
layout = [
    ...
    [sg.Text("")],
    [sg.Text('',expand_x=True),sg.Text('Horário:',font='Courier 14 italic bold',text_color='#4c5e91'), sg.Spin(horas,size=14,font='Courier 14 italic bold',text_color='black',readonly=True,enable_events=True, key='hora')
],
